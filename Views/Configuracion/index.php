                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="telefono" class="form-control" type="text" name="telefono" value="<?php echo $data['telefono']; ?>" required placeholder="Telefone" maxlength="15" onkeyup="validarTelefone(event)">
                                <small class="form-text text-muted">Formato: (DD) XXXXX-XXXX</small>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
